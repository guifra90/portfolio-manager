    ...
    const assetData = [
      {
        ...
        currentPrice: 107.08,
        averagePurchasePrice: 89.25, // (24200.08 - 4027.32) / 226 = 89.25
        quantity: 226,
        currentValue: 24200.08,
        purchaseValue: 20172.76,
        profitLoss: 4027.32,
        profitLossPercentage: 19.97,
      ...
      },
      {
        ...
        targetAllocation: 0.20,
        currentPrice: 7.54,
        averagePurchasePrice: 6.51, // (23313.68 - 3184.76) / 3092 = 6.51
        quantity: 3092,
        currentValue: 23313.68,
        purchaseValue: 20128.92,
        profitLoss: 3184.76,
        profitLossPercentage: 15.83,
      ...
      },
      {
        ...
        targetAllocation: 0.20,
        currentPrice: 229.04,
        averagePurchasePrice: 221.82, // (20842.64 - 656.11) / 91 = 221.82
        quantity: 91,
        currentValue: 20842.64,
        purchaseValue: 20186.53,
        profitLoss: 656.11,
      ...
      },
      {
        ...
        targetAllocation: 0.20,
        currentPrice: 110.65,
        averagePurchasePrice: 107.29, // (20802.20 - 631.68) / 188 = 107.29
        quantity: 188,
        currentValue: 20802.20,
        purchaseValue: 20170.52,
        profitLoss: 631.68,
      ...
      },
      {
        ...
        targetAllocation: 0.20,
        currentPrice: 258.42,
        averagePurchasePrice: 199.67, // (26100.42 - 5933.75) / 101 = 199.67
        quantity: 101,
        currentValue: 26100.42,
        purchaseValue: 20166.67,
        profitLoss: 5933.75,
        profitLossPercentage: 29.43,
    ...
    const adminAssetData = [
      {
        ...
        currentPrice: 85.50,
        averagePurchasePrice: 81.21, // (29925.00 - 1500.00) / 350 = 81.21
        quantity: 350,
        currentValue: 29925.00,
        purchaseValue: 28425.00,
        profitLoss: 1500.00,
        profitLossPercentage: 5.28,
      ...
      },
      {
        ...
        currentPrice: 50.25,
        averagePurchasePrice: 47.75, // (20100.00 - 1000.00) / 400 = 47.75
        quantity: 400,
        currentValue: 20100.00,
        purchaseValue: 19100.00,
        profitLoss: 1000.00,
